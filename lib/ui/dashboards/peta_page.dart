...
class _PetaPageState extends State<PetaPage> with TickerProviderStateMixin {
  ...
  Future<void> _goToMyLocation() async {
    ...
    try {
      ...
      _showSnack('GPS tidak tersedia. Aktifkan lokasi di pengaturan.', Colors.orange);
    }
  }
  ...
  Future<void> _openNavigation(TempatMakanModel item) async {
    ...
    try {
      ...
      final url = 'https://router.project-osrm.org/route/v1/driving/$origin;$dest?overview=full&geometries=geojson';
      ...
      if (response.statusCode == 200) {
        ...
        _showSnack('Rute ke ${item.name} ditampilkan di peta 🗺️', const Color(0xFF8B5E2A));
      } else {
  ...
  List<TempatMakanModel> get _mappedPlaces =>
      widget.tempatMakanList
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: const Color(0xFF8B5E2A).withValues(alpha: 0.15),
                            ),
                          ),
                          Container(
                            width: 20,
                          ...
                          child: TextField(
                            ...
                            onSubmitted: (query) {
                              ...
                              if (found.isNotEmpty) {
                                ...
                                setState(() {
                                  _selectedPlace = place;
                                  _selectedCardIndex = _mappedPlaces.indexOf(place);
                                });
                                _mapController.move(
                                  LatLng(place.latitude!, place.longitude!),
                                  16.0,
                                ...
                                _showSnack('Restoran tidak ditemukan di peta', Colors.orange);
                              }
                            },
                          ),
                        ),
                      ...
                      itemBuilder: (ctx, i) {
                        ...
                        return GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              color: active ? const Color(0xFF8B5E2A) : Colors.white,
                              borderRadius: BorderRadius.circular(20),
                              boxShadow: [
                                BoxShadow(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                ...
                                color: active ? Colors.white : const Color(0xFF2C1A0E),
                              ),
                            ),
                          ),
                        );
                ...
                child: const Row(
                  ...
                  children: [
                    SizedBox(width: 12, height: 12,
                      child: CircularProgressIndicator(strokeWidth: 2, color: Color(0xFF8B5E2A))),
                    SizedBox(width: 6),
                    Text('GPS...', style: TextStyle(fontSize: 11, color: Color(0xFF8B5E2A), fontWeight: FontWeight.w600)),
                  ],
                ),
              ),
            ),
              ...
              children: [
                ...
                if (_mappedPlaces.isEmpty)
                  Container(
                    ...
                    child: Row(
                      children: [
                        const Icon(Icons.info_outline, color: Color(0xFF8B5E2A), size: 20),
                ...
                if (_mappedPlaces.isNotEmpty)
                  SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (ctx, i) => _buildBottomCard(_mappedPlaces[i], i),
                    ),
                  ),
                ...
                Row(
                  children: [
                    ...
                    Text(
                      ...
                      style: const TextStyle(
                          fontSize: 12, fontWeight: FontWeight.bold, color: Color(0xFF2C1A0E)),
                    ),
                    if (distance.isNotEmpty) ...[
                      Text(' • ', style: TextStyle(color: Colors.grey[400], fontSize: 12)),
                      const Icon(Icons.directions_walk_rounded, size: 13, color: Color(0xFF8B5E2A)),
            ...
            children: [
              ...
              GestureDetector(
                onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (_) => DetailTempatMakanPage(tempatMakan: place)),
                ),
                child: Container(
                  width: 40,
                  height: 40,
              ...
              GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  height: 40,
                  decoration: BoxDecoration(
                    color: _routeDestination?.id == place.id && _routePoints.isNotEmpty
                        ? Colors.red.shade600
                        : const Color(0xFF8B5E2A),
                    borderRadius: BorderRadius.circular(10),
                  ),
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: 13,
                      fontWeight: FontWeight.bold,
                      color: selected ? const Color(0xFF8B5E2A) : const Color(0xFF2C1A0E),
                    ),
                  ),
                  const SizedBox(height: 3),
                  Row(
  ...
  Widget _thumbPlaceholder() {
    return Container(
      ...
      child: const Icon(Icons.restaurant_menu_rounded, color: Color(0xFF8B5E2A), size: 28),
    );
  }
  ...
  Widget _thumbSmall() {
    return Container(
      width: 60, height: 60,
      color: const Color(0xFFE8D5A3),
      child: const Icon(Icons.restaurant_menu_rounded, color: Color(0xFF8B5E2A), size: 24),
    );
  }
}
